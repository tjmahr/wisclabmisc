...
- [`rlang::as_name()`](https://rlang.r-lib.org/reference/as_name.html)
  ...
  which also returns a single string but supports any kind of R object
  as input, including quoted function calls and vectors. Its purpose is
  to summarise that object into a single label. That label is often
...
<https://tidyeval.tidyverse.org> and the [Metaprogramming
